...
namespace Fix24h_AdobeBricks_V1.Areas.Admin.Controllers
{
    [AuthorizeBusiness]
    public class ProjectProductsController : Controller
    {
        ...
        {
            return View(await db.ProjectProduct.ToListAsync());
        }
        ...
        public async Task<ActionResult> Details(int? id)
        {
            ...
            ProjectProduct projectProduct = await db.ProjectProduct.FindAsync(id);
            ...
            "UpdatedDate,UpdatedBy,MetaKeyword,MetaDescription,Status")] ProjectProduct projectProduct)
        {
            ...
            {
                db.ProjectProduct.Add(projectProduct);
        ...
        public async Task<ActionResult> Edit(int? id)
        {
            ...
            ViewBag.CategoryID = new SelectList(db.ProjectProduct, "ID", "Name", projectProduct.CategoryID);
            return View(projectProduct);
        }
        ...
        {
            ProjectProduct projectProduct = await db.ProjectProduct.FindAsync(id);
            db.ProjectProduct.Remove(projectProduct);
            await db.SaveChangesAsync();
            return RedirectToAction("Index");
        }
        ...
        public string ChangeImage(int? id, string picture)
        {
            ...
            ProjectProduct user = db.ProjectProduct.Find(id);
            if (user == null)
            {
                return "Mã không tồn tại";
            }
